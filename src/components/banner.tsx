      ...
      <div className="max-w-[1560px] mx-auto xl:px-10 md:px-6 px-4 pt-[22vh] sm:pt-[25vh] xl:pt-[28vh]">
        <div className="max-w-full sm:max-w-[520px] xl:max-w-[653px]">
          ...
          >
            <Link
              href={"#"}
              className="group relative overflow-hidden flex justify-center items-center gap-4 font-gotham font-medium text-[15px] xl:text-[16px] text-white bg-[#0CC1FA] w-full sm:w-[240px] xl:w-[274px] h-[52px] xl:h-[56px] rounded-[319px] transition-all duration-500 ease-out hover:shadow-[0_10px_35px_rgba(12,193,250,0.55)] active:scale-95"
            >
            ...
            <Link
              href="#"
              className="group relative w-fit font-gotham font-medium text-[14px] xl:text-[16px] text-white underline-offset-4 decoration-white/60 transition-all duration-300 ease-out hover:text-[#0CC1FA] hover:decoration-[#0CC1FA]"
            >
          ...
          <div
            className={`bg-[url(/banner-blur.png)] xl:bg-cover bg-[length:100%_100%] bg-center bg-no-repeat w-full sm:w-[440px] xl:w-[529px] h-auto xl:h-[123px] flex flex-col justify-center py-4 xl:py-0 pl-4 xl:pl-7 mt-[4vh] xl:mt-[5vh] transition-all duration-700 ease-out pb-[5vh] ${
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-x-6 sm:gap-x-10 xl:gap-13 gap-y-2 mt-[1vh]">

...
const ArrowIcon = () => (
  <svg
    ...
    className="h-[22px] w-[22px] shrink-0 sm:h-[26px] sm:w-[26px] xl:h-[30px] xl:w-[30px]"
  >
...
export default function Button({
  ...
  const base =
    "inline-flex w-fit items-center justify-center gap-3 font-gotham font-medium transition-colors duration-200";

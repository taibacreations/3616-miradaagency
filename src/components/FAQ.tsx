      ...
      <div className='max-w-content z-10 mx-auto relative px-4 sm:px-6 lg:px-8'>
        <div className='flex flex-col lg:flex-row justify-around items-center gap-10 lg:gap-25'>
          ...
          <div className='w-full lg:max-w-[670px]'>
            <h2 className='font-monument text-[28px] sm:text-[34px] lg:text-[40px] leading-[1.1] text-[#012549] capitalize mb-4 max-w-[370px]'>
              Alles wat <br /> je wil weten
            </h2>
            <p className='font-gotham text-[16px] sm:text-[18px] text-black mb-8'>
            ...
            <p className='font-gotham text-[16px] sm:text-[18px] text-black mb-4'>

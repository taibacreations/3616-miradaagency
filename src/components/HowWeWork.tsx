...
const HowWeWork = () => {
  return (
    <section id='werkwijze' className='w-full py-[60px] sm:py-[80px] lg:py-8'>

      <div className='max-w-[90%] sm:max-w-[670px] mx-auto xl:translate-y-10 2xl:translate-y-18 '>
        <h2 className='capitalize font-monument font-extrabold tracking-wide text-[20px] md:text-[25px] lg:text-[30px] xl:text-[40px] text-[#012549] text-center'>
          Hoe We Samenwerken
        </h2>
        <p className='capitalize font-gotham text-[13px] md:text-[15px] lg:text-[16px] xl:text-[18px] text-black text-center'>
        ...
        <div className='relative xl:absolute xl:inset-0 z-10 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-[clamp(24px,4vw,80px)] py-10 sm:py-14 lg:py-[clamp(24px,3vw,56px)]'>
          ...
          <div className='w-full max-w-content mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 lg:gap-[clamp(14px,1.6vw,30px)]'>
            ...
            <div className='relative bg-white rounded-3xl py-[30px] px-[20px] sm:py-[40px] sm:px-[25px] lg:py-[clamp(24px,2.6vw,50px)] lg:px-[clamp(18px,1.8vw,30px)]'>
              <span className='absolute z-50 top-[3px] right-[15px] sm:right-[20px] lg:right-[clamp(12px,1.2vw,20px)] font-gotham font-extrabold text-black/10 text-[40px] sm:text-[55px] lg:text-[clamp(38px,3.6vw,70px)]'>
                01
              </span>
              <h3 className='font-gotham font-extrabold max-w-[80%] sm:max-w-[200px] lg:max-w-[75%] text-[18px] md:text-[20px] lg:text-[22px] lg:text-[24px]'>
                Kennismaking (30 min, gratis)
              </h3>
              <p className='font-gotham text-[13px] md:text-[15px] lg:text-[16px] xl:text-[18px] max-w-full sm:max-w-[270px] lg:max-w-full mt-2 leading-[1.5]'>
            ...
            <div className='relative bg-white rounded-3xl py-[30px] px-[20px] sm:py-[40px] sm:px-[25px] lg:py-[clamp(24px,2.6vw,50px)] lg:px-[clamp(18px,1.8vw,30px)]'>
              ...
              <h3 className='font-gotham font-extrabold max-w-[80%] sm:max-w-[200px] lg:max-w-[85%] text-[18px] md:text-[20px] lg:text-[22px] lg:text-[24px]'>
                Offerte & Plan
              </h3>
              <p className='font-gotham text-[13px] md:text-[15px] lg:text-[16px] xl:text-[18px] max-w-full sm:max-w-[270px] lg:max-w-full mt-2 leading-[1.5]'>
            ...
            <div className='relative bg-white rounded-3xl py-[30px] px-[20px] sm:py-[40px] sm:px-[25px] lg:py-[clamp(24px,2.6vw,50px)] lg:px-[clamp(18px,1.8vw,30px)]'>
              <span className='absolute z-50 top-[3px] right-[15px] sm:right-[20px] lg:right-[clamp(12px,1.2vw,20px)] font-gotham text-[40px] sm:text-[55px] lg:text-[clamp(38px,3.6vw,70px)] font-extrabold text-black/10'>
                03
              </span>
              <h3 className='font-gotham font-extrabold max-w-[80%] sm:max-w-[200px] lg:max-w-[85%] text-[18px] md:text-[20px] lg:text-[22px] lg:text-[24px]'>
                Aan de Slag
            ...
            <div className='relative bg-white rounded-3xl py-[30px] px-[20px] sm:py-[40px] sm:px-[25px] lg:py-[clamp(24px,2.6vw,50px)] lg:px-[clamp(18px,1.8vw,30px)]'>
              ...
              <h3 className='font-gotham font-extrabold max-w-[80%] sm:max-w-[250px] lg:max-w-[85%] text-[18px] md:text-[20px] lg:text-[22px] lg:text-[24px]'>
                Groei & Aanpassen
              </h3>
              <p className='font-gotham text-[13px] md:text-[15px] lg:text-[16px] xl:text-[18px] max-w-full sm:max-w-[270px] lg:max-w-full mt-2 leading-[1.5]'>
          ...
          <p className='w-full max-w-[90%] sm:max-w-[700px] lg:max-w-[960px] text-center mx-auto text-white font-gotham text-[13px] md:text-[15px] lg:text-[16px] xl:text-[18px] mt-6 lg:mt-[clamp(20px,2.3vw,45px)] leading-[1.5]'>

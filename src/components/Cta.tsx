        ...
        <div className="relative overflow-hidden rounded-[18px] min-h-[230px] sm:min-h-[270px] md:min-h-0">
          ...
          <div className="absolute inset-0 z-10 flex items-center">
            <div className="px-4 max-w-[240px] sm:px-5 sm:max-w-[300px] md:px-5 md:max-w-[550px] lg:px-10 lg:max-w-[600px] xl:max-w-[790px] xl:px-18">
              ...
              <h3 className="font-gotham text-white font-bold text-[13px] sm:text-[15px] md:text-[18px] xl:text-[24px] pb-2 md:pb-2 lg:pb-4 leading-snug">
                Klaar voor meetbaar resultaat?
              </h3>

              <p className="font-gotham text-white text-[9px] sm:text-[10.5px] md:text-[15px] xl:text-[20px] pb-3 sm:pb-4 md:pb-2 lg:pb-6 capitalize leading-relaxed">

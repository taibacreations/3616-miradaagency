...
"Automatiseringen volgen leads op, zodat je geen kansen mist",
    ...
    >
      <div className="pt-[8vh] xl:pt-[14.5vh]">
        <div className="max-w-full xl:max-w-[984px] mx-auto text-center px-4 md:px-5  xl:px-0">
          <h2 className="font-bold text-[26px] sm:text-[32px] xl:text-[40px] text-white tracking-[0.02em] leading-[34px] sm:leading-[40px] xl:leading-[46px]">
            Van handmatig naar automatisch
          </h2>
          <p className="text-[14px] sm:text-[16px] xl:text-[18px] text-white mt-[1.5vh] leading-[22px]">
            ...
            <div className="bg-[#F5F9FC] rounded-[18px] xl:rounded-[24px] w-full 2xl:w-[648px] md:h-full xl:min-h-[291px] 2xl:h-[291px] h-auto flex justify-center flex-col gap-3 sm:gap-4 xl:gap-5 px-4 sm:px-5 xl:pl-8.5 xl:pr-0 py-6 sm:py-7 xl:py-6 2xl:py-0 z-10 relative">
              {nowPoints.map((text) => (
                <div key={text} className="flex items-start gap-2">
                  ...
                  />
                  <h3 className=" text-[14px] sm:text-[16px] xl:text-[18px] leading-[20px] xl:leading-normal  text-[#333333] -mt-[3px] xl:-mt-[4px]">
                    {text}
                  </h3>
                </div>
              ))}

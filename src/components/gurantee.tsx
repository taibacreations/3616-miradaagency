const Gurantee = () => {
  return (
    <section className="bg-white pt-[7vh] pb-[13vh]">
      <div className="max-w-[1560px] mx-auto xl:px-10 md:px-6 px-4 flex flex-col md:flex-row justify-between items-center gap-8 lg:gap-6 xl:gap-10">
        <div className="w-full lg:w-[500px] xl:w-[540px] 2xl:w-[678px]">
          <img
            src="/gurantee.png"
            alt="gurantee"
        ...
        <div className="bg-[#F5F9FC] rounded-[24px] w-full lg:w-[600px] xl:w-[700px] 2xl:w-[725px] h-auto lg:min-h-[340px] xl:min-h-[365px] px-[6%] sm:px-[5.5%] py-[4%] lg:py-[3.5%] lg:pt-[3.5%]">
